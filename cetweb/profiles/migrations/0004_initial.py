...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_profile', (
            ...
            ('stakeholder', self.gf('django.db.models.fields.CharField')(default='founder', max_length=50)),
            ...
            ('industries', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
