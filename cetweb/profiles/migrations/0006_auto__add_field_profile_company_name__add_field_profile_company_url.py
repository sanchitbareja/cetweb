...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.company_name'
        db.add_column('profiles_profile', 'company_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.company_url'
        db.add_column('profiles_profile', 'company_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.company_name'
        db.delete_column('profiles_profile', 'company_name')

        # Deleting field 'Profile.company_url'
        db.delete_column('profiles_profile', 'company_url')
