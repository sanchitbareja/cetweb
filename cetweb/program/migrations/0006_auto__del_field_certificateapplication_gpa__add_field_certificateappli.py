...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CertificateApplication.gpa'
        db.delete_column('program_certificateapplication', 'gpa')

        # Adding field 'CertificateApplication.GPA'
        db.add_column('program_certificateapplication', 'GPA',
