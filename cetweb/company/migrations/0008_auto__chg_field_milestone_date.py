...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Milestone.date'
        db.alter_column('company_milestone', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Milestone.date'
        db.alter_column('company_milestone', 'date', self.gf('django.db.models.fields.DateTimeField')())
