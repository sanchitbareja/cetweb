...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('company_investor', (
        ...
        db.send_create_signal('company', ['Investor'])

        # Adding M2M table for field companies on 'Investor'
        db.create_table('company_investor_companies', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('investor', models.ForeignKey(orm['company.investor'], null=False)),
            ('company', models.ForeignKey(orm['company.company'], null=False))
        ))
        db.create_unique('company_investor_companies', ['investor_id', 'company_id'])


    def backwards(self, orm):
        # Deleting model 'Investor'
        db.delete_table('company_investor')

        # Removing M2M table for field companies on 'Investor'
        db.delete_table('company_investor_companies')
